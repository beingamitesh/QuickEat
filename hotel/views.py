...
from .models import Customer, Comment, Order, Food, Cart, OrderContent
...
def placeOrder(request):
    ...
    to_email.append(to)
    from_email = 'rajatsrivastava2221997@gmail.com'
    message = "Hi "+customer.customer.first_name+" Your order was placed successfully. Please go to your dashboard to see your order history. <br>"
    send_mail(
        mail_subject,
        message,
        from_email,
...
def bookTable(request):
    ...
    to_email.append(to)
    from_email = 'rajatsrivastava2221997@gmail.com'
    message = "Hi "+customer.customer.first_name+" Your order was placed successfully. Please go to your dashboard to see your order history."
    send_mail(
        mail_subject,
        message,
        from_email,
